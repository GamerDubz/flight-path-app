  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col bg-[#f2f5fd] overflow-hidden animate-in fade-in duration-200">
      ...
      <div className="w-full h-full flex flex-col relative z-10 overflow-hidden">
        ...
        {/* Scrollable Content */}
        <main className="flex-1 overflow-y-auto px-5 pb-[120px] pt-4 flex flex-col no-scrollbar">
        ...
        {/* Bottom Bar */}
        <div className="w-full bg-linear-to-t from-white via-white/95 to-white/0 pt-8 px-5 pb-8 sm:pb-12 absolute bottom-0 left-0 z-40 pointer-events-none flex justify-center">
          <button form="add-flight-form" type="submit" className="w-full lg:max-w-[900px] sm:max-w-[600px] bg-[#007AFF] text-white font-medium text-[16px] py-4 rounded-[20px] shadow-[0_4px_14px_rgba(0,122,255,0.3)] hover:opacity-90 active:scale-[0.98] transition-all pointer-events-auto">
              Add Flight
          </button>
        </div>
